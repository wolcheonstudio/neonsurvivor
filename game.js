...
(() => {
  ...
  const executeStartGame = () => {
    try {
      resize(); 
      player.x = 0; player.y = 0; player.hp = 100; player.maxHp = 100; player.xp = 0; player.level = 1; player.coins = 0; player.speed = 280; 
      player.weapon.damage = 10; player.xpNeeded = 3; player.ampoules = { small: 0, medium: 0, large: 0, giant: 0 };
